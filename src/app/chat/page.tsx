...
const CHATS: Chat[] = [
    { id: "1", name: "Meghalaya Adventure", type: "group", avatar: "🏔️", lastMsg: "Arjun: I booked the cab for Dawki!", time: "2m", unread: 3, members: 4 },
    { id: "2", name: "Goa New Year Crew", type: "group", avatar: "🏖️", lastMsg: "Priya shared a location", time: "18m", unread: 0, members: 28 },
    ...
    { id: "5", name: "Kedarnath Trek Group", type: "group", avatar: "⛰️", lastMsg: "Rahul: Weather update — clear skies!", time: "5h", unread: 0, members: 18 },
