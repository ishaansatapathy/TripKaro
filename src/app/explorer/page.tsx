...
const CATEGORIES: { key: Category; label: string; icon: string; emoji: string }[] = [
    { key: "all", label: "All Places", emoji: "🗺️", icon: "M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" },
    ...
    { key: "restaurants", label: "Restaurants", emoji: "🍽️", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 1v8m0 0v1" },
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-10">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {[
                            ...
                            { title: "Local Restaurants", desc: "From street food to fine dining, curated by local ratings and traveler reviews.", icon: "🍽️", count: "500+" },
